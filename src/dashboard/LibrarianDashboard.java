...
public class LibrarianDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("LMS");
        setPreferredSize(new java.awt.Dimension(927, 630));

        dashboardTabbed.setBackground(new java.awt.Color(255, 255, 255));
        ...
        issueTable.setPreferredSize(new java.awt.Dimension(676, 0));
